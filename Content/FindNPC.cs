...
{
    public partial class FindNPC : Form
    {
        public FindNPC()
        {
           InitializeComponent();
        ...
        {
            Settings.Default.SelectNPC1 = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            Settings.Default.SelectNPC1Region = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();
        }
